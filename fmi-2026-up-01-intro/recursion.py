...
def tree_list_sum[E](l: list[E | list[E]], zero_val: E = None) -> E:
    if not l:
        return zero_val
    return _tree_list_sum(l, get_leaf_type(l))

def _tree_list_sum[E](l: list[E], elem_type_ctor) -> E:
    # print(l, elem_type_ctor)
    if not type(l) is list:  # l is a leaf of type E
        return l
    if not l:
        return elem_type_ctor()  # zero value for type E
    # print('--->', _tree_list_sum(l[0], elem_type_ctor), _tree_list_sum(l[1:], elem_type_ctor))
    return _tree_list_sum(l[0], elem_type_ctor) + _tree_list_sum(l[1:], elem_type_ctor) # Head + Tail
...
if __name__ == '__main__':
    ...
    t1 = [1, [2, [3, 4], 5], 6, [7, 8]]
    t2 = [(1,), [(2,), [(3, 4)], (5,)], (6,), [(7,), (8,)]]
    print(tree_list_sum(t1))
    print(tree_list_sum(t2))
