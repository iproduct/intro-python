...
if __name__ == '__main__':
    ...
    month = int(input("Month of #birth:")) #dsffdgfdgfdfdhgfhgf
    ...
    if (number == 1):
        ...
        print(
            "Да се научим на състрадание, толерантност, благотворителност. #Професии свързани с нетрадиционно мислене чрез духовно израстване – пионери във всяка една област, хора, които променят разбиранията ни за света и човечеството.")#long string
