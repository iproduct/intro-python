...
def calculateSumOfDigits(number):
    ...
    if (type(number) is int):
        ...
        for element in range(0, len(number)):
            sum = sum + int(number[element])
    return sum


if __name__ == '__main__':
    a = input("Enter: ");
    print(calculateYear(a))
    print(number)
    messages = ["""Да се научим да поемаме отговорност и преодоляваме трудностите чрез разум. Самостоятелен бизнес, търговски представител, програмист.""",
                ...
                чрез духовно израстване – пионери във всяка една област, хора, които променят разбиранията ни за света и човечеството."""]
