...
books = [
    ...
    (
    9, "Python Cookbook 3 ed.", "Recipes for Mastering Python 3", "Браян К. Джоунс и Дейвид М. Баазли", "O'Reily", 2011,
    135.9)
]
...
if __name__ == "__main__":
    ...
    # s = json.dumps(books_dicts, indent=4, ensure_ascii=False)
    # print(s)
    # and_back = json.loads(s)
    # print(and_back)

    # jsonify to/from file
    with open("books.json", "wt", encoding="utf-8") as f:
        json.dump(books_dicts, f, indent=4, ensure_ascii=False)
    with open("books.json", "rt", encoding="utf-8") as f:
        and_back = json.load(f)
    print(and_back)
