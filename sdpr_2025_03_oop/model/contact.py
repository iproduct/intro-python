...
class Contact:
    ...
    def __str__(self):
        return f'| {self.id:24.24s} |{self.first_name:10.10s} | {self.last_name:10.10s} | {self.phone_number:10.10s} | {self.email:15.15s} | {self.address:15.15s} | {self.created.strftime("%d.%m.%Y"):10.10s} | {self.modified.strftime("%d.%m.%Y"):10.10s} |'
