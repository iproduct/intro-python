...
from repository.contact_repository_csv import ContactRepositoryCsv
...
if __name__ == '__main__':
    ctrl = ContactController('conacts.csv', ContactRepositoryCsv('contacts.csv')) # Constructor-based dependency injection
    ctrl.start()