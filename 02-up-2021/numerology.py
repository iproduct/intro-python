...
if __name__ == '__main__':
    ...
    print("Yuor number is: ", number)

    # Messagess to be printed
    messages = [
        ...
        """Да се научим на взискателност, целеустременост, постоянство. Професии свързани с риск – криминалист, 
        съдебен медик, траурен агент, банкер, медиум.""",
        """Да се научим на състрадание, толерантност, благотворителност. Професии свързани с нетрадиционно мислене чрез 
        духовно израстване – пионери във всяка една област, хора, които променят разбиранията ни за света и човечеството."""
    ]
