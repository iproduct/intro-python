...
class BookRepository:
    ...
    def find_by_name_part(self, name_part):
        return self.findByPredicate(lambda book : name_part in book.title)

    def find_by_name_descr_part(self, part):
        return self.findByPredicate(lambda book : part in book.title or part in book.descr)

    def find_by_name_descr_part(self, part):
        return self.findByPredicate(lambda book : part in ",".join(book.authors))
